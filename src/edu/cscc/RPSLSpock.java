...
/**
 * RPSLSpock class for generating users and computers pick for rock, paper, scissors, lizard, and spock
 * @author Nayla Morbitzer
 */
public class RPSLSpock {
    ...
    /**
     * isValidPick() method checks the users input to ensure it's a valid pick
     * @param pick users pick
     * @return users valid inputs
     */
    ...
    /**
     * generatePick() method generates computers pick
    ...
    /**
     * isComputerWin() method generates scenarios needed for computer to win
     * @param c_pick computers pick
     * @param h_pick humans pick
     * @return Scenario for computer to win
     */
